...
/* INDEX PAGE INPUT */
const indexID = document.getElementById('search-id')
const indexString = document.getElementById('search-string')
const indexInteger = document.getElementById('search-integer')
const indexFloat = document.getElementById('search-float')
const indexDate = document.getElementById('search-date')
const indexBoolean = document.getElementById('search-boolean')
